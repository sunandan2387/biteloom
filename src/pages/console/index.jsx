...
<div className="min-h-screen bg-white text-gray-900 flex flex-col items-center p-6 w-full">
  ...
  <div className="w-full max-w-3xl relative mt-12">
    <input
      ...
      className="w-full bg-gray-100 text-gray-900 rounded-lg px-4 py-2 pl-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
    />
    <Search className="absolute left-3 top-2 text-gray-500" size={18} />
  </div>

  {/* Setup Card */}
  <div className="bg-gray-100 p-4 rounded-lg shadow-md mt-6 max-w-3xl w-full flex items-center">
    <Rocket size={24} className="text-green-500 mr-4" />
    <div className="flex-1">
      <h3 className="font-semibold">Set up your workspace</h3>
      <p className="text-gray-600 text-sm">
        Follow this step-by-step guide to set up your new ByteLoom account.
      </p>
    </div>
    <a
      href="/workspace/"
  ...
  <div className="mt-24 text-center border border-dashed border-gray-300 p-6 rounded-lg bg-gray-100 max-w-lg">
    <h2 className="text-xl font-semibold">Start your journey</h2>
    <p className="text-gray-600 max-w-lg mx-auto">
      Try the "New" menu, where you can use github repository to run spark jobs
    </p>
