...
<div className="md:w-96 mx-auto my-24">
  <div className="rounded-lg border text-gray-800 shadow-xl bg-white">
    <div className="flex flex-col p-6 space-y-1">
      <h3 className="font-semibold tracking-tight text-2xl">Login to your Account</h3>
      {/* <p className="text-sm text-gray-500">Enter your email and password below to login</p> */}
    </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-2">
          ...
          <input
            ...
            value={email}
            className="flex h-10 w-full rounded-md border px-3 py-2 text-sm bg-white text-gray-800"
            placeholder="Email"
            id="email"
            type="text"
            name="email"
        ...
        <div className="mt-10">
          <button type="submit" className="bg-indigo-500 hover:bg-indigo-600 text-white w-full py-2 rounded-md">
            Login
          </button>
        </div>
      </form>
