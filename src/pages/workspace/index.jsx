...
const Workspace = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-6 w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:gri-cols-6 gap-5 p-3 md:p-6 w-full">
        {/* Add New Workspace Card */}
        <div
          onClick={() => setOpenModal(true)}
          className="border border-dashed border-gray-600 p-6 rounded-lg bg-gray-600 bg-opacity-20 cursor-pointer hover:scale-105 duration-200 group shadow-md flex items-center justify-center sm:h-[200px] w-full h-48"
        >
          <IoAdd
        ...
        {workspaces &&
          workspaces.map((workspaceData, index) => (
            ...
            >
              <div className="border border-dashed relative border-gray-600 z-10 p-6 rounded-lg bg-gray-600 bg-opacity-20 flex flex-col justify-between group shadow-md cursor-pointer hover:scale-105 duration-200 sm:h-[200px] w-full h-48">
                <MdEdit
